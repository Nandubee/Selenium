...
public class EditLeads {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//input[@name='companyName'])[2]")).sendKeys("TSL");
		driver.findElement(By.xpath("(//input[@name='firstName'])[3]")).sendKeys("Niranj");
		driver.findElement(By.xpath("(//input[@name='lastName'])[3]")).sendKeys("Sayi");
		driver.findElement(By.xpath("//input[@name='firstNameLocal']")).sendKeys("Niranj");
		driver.findElement(By.xpath("//input[@name='departmentName']")).sendKeys("Engineer");
		driver.findElement(By.xpath("(//textarea[@name='description'])[1]")).sendKeys("Designation as Tester");
		...
		driver.findElement(By.xpath("(//input[@name='primaryPhoneNumber'])[4]")).sendKeys("8589987339");
		driver.findElement(By.xpath("(//input[@name='primaryEmail'])[4]")).sendKeys("niransayitsl@gmail.com");
		...
		driver.findElement(By.xpath("(//div[@class='x-form-element']/input[@name='lastName'])[3]")).sendKeys("Sayi");
